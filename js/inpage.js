        ...
        (function (t, r) {
          (function () {
            ...
            (() => {
              ...
              n.default.setDefaultLevel(
                t.env.METAMASK_DEBUG ? "debug" : "warn"
              );
        ...
        class l extends i.Duplex {
          ...
          createStream(e) {
            ...
            return (
              ...
              (function (e, t) {
                const r = s.default(t);
                o.default(e, { readable: !1 }, r),
                  o.default(e, { writable: !1 }, r);
              ...
              this._jsonRpcConnection.events.on("notification", (t) => {
                ...
                "metamask_accountsChanged" === r
                  ...
                  : "METAMASK_STREAM_FAILURE" === r &&
                    e.destroy(
                      new Error(d.default.errors.permanentlyDisconnected())
                    );
              });
          }
          isConnected() {
          ...
          return (t, r, i) => {
            ("string" == typeof t.method && t.method) ||
              ...
              i((t) => {
                const { error: n } = r;
                return n
                  ? (e.error(`MetaMask - RPC Error: ${n.message}`, n), t())
                  : t();
              });
          };
        };
      ...
      function (e, t, r) {
        ...
        class s extends i.default {
          ...
          async _processRequest(e, t) {
            ...
            if (
              (s._checkForCompletion(e, t, n), await s._runReturnHandlers(i), r)
            )
              throw r;
          }
